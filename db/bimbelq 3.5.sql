...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Nov 2024 pada 13.23
...
(1, 1, 'Kelas A', 4, 'reguler', '2024-11-25 08:00:00'),
(2, 2, 'Kelas B', 5, 'reguler', '2024-11-27 10:00:00'),
(3, 3, 'Kelas Privat C', 5, 'privat', '2024-11-29 12:00:00');
...
(1, 2, 'reguler', 'transfer', 500000.00, '2024-11-23', NULL, '2024-11-25', 'pending', 'https://templates.invoicehome.com/receipt-template-us-neat-750px.png'),
(2, 3, 'privat', 'cash', 750000.00, '2024-11-23', NULL, '2024-11-30', 'lunas', NULL);
...
(1, 2, 3, 4, '2024-11-22 09:00:00', 'mau ujian', 'pending', '2024-11-23'),
(2, 3, 1, 5, '2024-11-23 13:00:00', 'ada remidi', 'accepted', '2024-11-23');
...
(1, 2, 2, 1, 'ada acara keluarga', 'accepted', '2024-11-23'),
(2, 3, 1, 2, 'ada kegiatan', 'pending', '2024-11-23');
...
('WL80EXryv2gcZBgZd_1q82XCynELq3cA', 1732450938, '{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2024-11-24T11:57:26.738Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"Lax\"},\"user\":{\"id_user\":1,\"username\":\"admin1\",\"role\":\"admin\",\"nama\":\"\"}}');
