...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Nov 2024 pada 13.55
...
CREATE TABLE `request_kelas_reguler` (
  ...
  `id_siswa` int(11) NOT NULL,
  `id_kelas_lama` int(11) DEFAULT NULL,
...
INSERT INTO `request_kelas_reguler` (`id_request_reguler`, `id_siswa`, `id_kelas_lama`, `id_kelas_baru`, `status_request`, `tanggal_request`) VALUES
(1, 2, NULL, 1, 'accepted', '2024-11-21'),
(2, 3, NULL, 2, 'pending', '2024-11-21');
...
ALTER TABLE `request_kelas_reguler`
  ...
  ADD KEY `id_siswa` (`id_siswa`),
  ADD KEY `id_kelas_lama` (`id_kelas_lama`),
  ADD KEY `id_kelas_baru` (`id_kelas_baru`);
...
ALTER TABLE `request_kelas_reguler`
  ...
  ADD CONSTRAINT `request_kelas_reguler_ibfk_2` FOREIGN KEY (`id_kelas_lama`) REFERENCES `kelas` (`id_kelas`) ON DELETE CASCADE,
  ADD CONSTRAINT `request_kelas_reguler_ibfk_3` FOREIGN KEY (`id_kelas_baru`) REFERENCES `kelas` (`id_kelas`) ON DELETE CASCADE;
