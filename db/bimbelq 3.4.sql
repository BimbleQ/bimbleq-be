...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Nov 2024 pada 17.46
...
INSERT INTO `kelas` (`id_kelas`, `id_matpel`, `nama_kelas`, `id_pengajar`, `tipe`) VALUES
(1, 1, 'Kelas A', 4, 'reguler'),
(2, 2, 'Kelas B', 5, 'reguler'),
(3, 3, 'Kelas Privat C', 5, 'privat');
...
(1, 2, 'reguler', 'transfer', 500000.00, '2024-11-22', NULL, '2024-11-25', 'pending', 'https://templates.invoicehome.com/receipt-template-us-neat-750px.png'),
(2, 3, 'privat', 'cash', 750000.00, '2024-11-22', NULL, '2024-11-30', 'lunas', NULL);
...
(1, 2, 3, 4, '2024-11-22 09:00:00', 'mau ujian', 'pending', '2024-11-22'),
(2, 3, 1, 5, '2024-11-23 13:00:00', 'ada remidi', 'accepted', '2024-11-22'),
(3, 2, 1, 4, '2024-11-12 22:00:00', 'lagi rajin', 'pending', '2024-11-22');
...
(1, 2, 2, 1, 'ada acara keluarga', 'accepted', '2024-11-22'),
(2, 3, 1, 2, 'ada kegiatan', 'pending', '2024-11-22');
...
('BYTXk6PlOtP-_zcq3r5jU2xubQrjekTA', 1732379739, '{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2024-11-23T16:34:27.424Z\",\"httpOnly\":true,\"path\":\"/\"},\"user\":{\"id_user\":2,\"username\":\"siswa1\",\"role\":\"siswa\"}}');
...
--
ALTER TABLE `request_kelas_privat`
  MODIFY `id_request_privat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
